...
class GradeReport extends React.Component {
    ...
    displayAssignmentGradeReport(AI_ID, sectionID, assignmentIdentifier) {
        this.setState({
            ...
            tableSubheader: assignmentIdentifier.replaceAll("_", " - ")
        });
    }
    ...
    displayProblemGradeReport(workflowData, user, userGrade, oneWorkflow) {
        ...
        this.setState({
            ...
            problemGradeReport: (
                <ProblemGradeReport
                    ...
                    tableSubheader={this.state.tableSubheader}>
                </ProblemGradeReport>
            )
        });
    }
    ...
    displayAsgECTimelinessGradesDetailReport(timelinessGrade, gradeData) {
        this.setState({
