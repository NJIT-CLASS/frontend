...
class DeletedAssignments extends Component {
    ...
    bindButtons(assignments) {
        return assignments.map(assignment => {
            return {
                ...
                restoreButton: assignment.RemovedAssignment != null || assignment.Assignment == null ?
    ...
    restoreAssignment(event) {
        ...
        apiCall.get(`/restoreremovedinstance/${selectedAssignment.assignmentId}`, (err, res, body) => {
