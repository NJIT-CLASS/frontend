...
var renderValue = () => {
  ...
  return (
    <div>
      <Select name={name} options={props.options} valueRenderer={this.renderValue} optionRenderer={this.renderOption} value={this.status.value} valueRenderer={this.renderValue} onChange={props.changeSelectedStatus.bind(this,props)} />
    </div>
  );
}
