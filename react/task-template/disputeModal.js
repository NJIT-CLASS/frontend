...
const DisputeModal = ({ okLabel, cancelLabel, title, list, show, proceed, dismiss, cancel, confirmation, options }) => {
    // let listView = null;
...
const confirm = createConfirmation(confirmable(DisputeModal));
