...
exports.get = function (req, res) {
    ...
    req.App.api.get('/course/getCourses/' + req.App.user.userId, function (err, statusCode, body) {
        var courseList = [];
        ...
        req.App.api.get('/getPendingTaskInstances/' + req.App.user.userId, function (err1, statusCode1, bod) {
            ...
            req.App.api.get('/getCompletedTaskInstances/' + req.App.user.userId, function (err2, statusCode2, bo) {
                ...
                if (bod.PendingTaskInstances == null || bod.PendingTaskInstances == undefined) {
                    //PendingTasks defined in backend Rest.js
                    res.render('dashboard', {
                        courseList: courseList,
                        pendingTasksList: pendingTasksList, //empty
                        completedTasksList: completedTasksList
